...
const ServiceCard = ({color, title, icon, subTitle}: any) => (
    <div className='flex flex-row justify-start items-center white-glassmorphism p-2 m-3 cursor-pointer hover:shadow-xl'>
        ...
        <div className='flex flex-col mf:flex-row  w-full justify-center items-center gradient-bg-services'>
            <div className='flex mf:flex-row flex-col items-center justify-between md:p-20 py-12 px-4'>
                <div className='flex-1 flex flex-col justify-start items-start'>
                    <h1 className='text-3xl sm:text-5xl text-gradient py-5'>
                        Services that we
                        <br />
                        continue to improve
                    </h1>
